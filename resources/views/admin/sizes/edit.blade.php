...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-4">{{ __('Edit Size') }}</h1>
        <p class="mt-1 text-sm text-gray-600">{{ __('Update size information with multilingual support') }}</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('admin.sizes.update', $size) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="name_en" name="name_en" value="{{ old('name_en', $size->name_en) }}"
            ...
            <div>
                ...
                <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $size->sort_order) }}"

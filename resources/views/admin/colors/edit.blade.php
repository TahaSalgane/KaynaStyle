...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-4">{{ __('Edit Color') }}</h1>
        <p class="mt-1 text-sm text-gray-600">{{ __('Update color information with multilingual support') }}</p>
    </div>
        ...
        <form action="{{ route('admin.colors.update', $color) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="text-center">
                <div class="w-24 h-24 rounded-full border-4 border-gray-200 shadow-lg mx-auto mb-4"
                     id="colorPreview" style="background-color: {{ $color->hex_code }};"></div>
            ...
            <div>
                ...
                <input type="text" id="name_en" name="name_en" value="{{ old('name_en', $color->name_en) }}"

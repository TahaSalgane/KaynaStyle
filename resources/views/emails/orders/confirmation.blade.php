                            ...
                            <div style="background-color: #f9fafb; border-radius: 8px; padding: 20px; margin: 30px 0; border-left: 4px solid #a67c5a;">
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0; text-align: right; color: #a67c5a; font-size: 16px; font-weight: 700;">${{ number_format($order->total_amount, 2) }}</td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        ...
                                        <td style="vertical-align: top;">
                                            ...
                                            <p style="margin: 8px 0 0 0; color: #a67c5a; font-size: 16px; font-weight: 700;">${{ number_format($item->total_price, 2) }}</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
